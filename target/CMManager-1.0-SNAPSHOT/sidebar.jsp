    ...
    <body>
        <aside>
            <div class="sidebar">
                ...
                <ul class="side-menu">
                    <li id="analytics"><a href="analytics"><i class='bx bx-home-heart'></i> Analytics</a></li>
                    <li id="orderManagement"><a href="orderManagement"><i class='bx bx-store'></i> Order</a></li>
                    <li id="listMenu">
                        <a href="listMenu"><i class='bx bx-notepad'></i> Menu</a>
                        <ul class="sub-menu">
                    ...
                    <li id="employeeManagement">
                        <a href="employeeManagement"><i class='bx bx-group'></i> Employee</a>
                        <ul class="sub-menu">
                            <li><a href="employeeManagement">List Employee</a></li>
                            <li><a href="createAccount">Create Account</a></li>
                        </ul>
                    </li>
                    <li id="customerManagement"><a href="customerManagement"><i class='bx bxs-user-badge'></i> Customer</a></li>
                    
                    <li id="logout"><a href="logout" class="logout"><i class='bx bx-exit'></i> Logout</a></li>
                </ul>
            </div>
        </aside>
        <div class="content">
